<template>
  <section class="card">
    ...
    <div class="map-panel">
      <div class="heatmap">
        <span class="heat-spot large primary" style="top: 12%; left: 8%;"></span>
        <span class="heat-spot medium accent" style="top: 28%; left: 34%;"></span>
        <span class="heat-spot small warning" style="top: 18%; left: 68%;"></span>
        <span class="heat-spot medium warning" style="top: 56%; left: 18%;"></span>
        <span class="heat-spot large accent" style="top: 58%; left: 52%;"></span>
        <span class="heat-spot small primary" style="top: 68%; left: 78%;"></span>
        <span class="heat-spot medium primary" style="top: 38%; left: 72%;"></span>
      </div>
...
.heat-spot.primary {
  background: radial-gradient(circle, rgba(47, 128, 237, 1), rgba(47, 128, 237, 0));
}

.heat-spot.accent {
  background: radial-gradient(circle, rgba(61, 213, 152, 1), rgba(61, 213, 152, 0));
}

.heat-spot.warning {
  background: radial-gradient(circle, rgba(242, 153, 74, 1), rgba(242, 153, 74, 0));
}
